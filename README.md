...
To further boost performance, we pre-train the ResNet-18 backbone on a large-scale medical dataset (e.g., RadImageNet or proprietary data) to learn domain-specific features (Modality & Anatomy classification).
